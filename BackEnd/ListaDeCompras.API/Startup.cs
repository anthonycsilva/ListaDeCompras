...
using ListaDeCompras.Business.Services;
using ListaDeCompras.Infra.Data.Context;
using ListaDeCompras.Infra.Data.Repositories;
    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ListaDeCompras.API v1"));
            }
